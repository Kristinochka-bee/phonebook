...
public class ApiBase {
    ...
    RequestSpecification spec = new RequestSpecBuilder() //собираем общие данные для всех будущих запросов
            ...
            .addHeader("Access-Token", API_KEY) // для авторизации каждый раз
            .build();

    public Response doPostReequest(String endPoint, Integer responseCode, Object dto) {   //Object dto - класс на кот будет формировать тело запросов (будут сод поля как и поля json)
